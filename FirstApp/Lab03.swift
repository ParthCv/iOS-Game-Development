...
class RotatingCrate: SCNScene {
    ...
    func addCube() {
        ...
        let materials = [UIImage(named: "crate.jpg"), UIImage(named: "box.png"), UIImage(named: "face.gif")] // List of materials for each side
...
//        nextMaterial = SCNMaterial()
//        nextMaterial.diffuse.contents = materials[1]
//        theCube.geometry?.insertMaterial(nextMaterial, at: 3)
//        
